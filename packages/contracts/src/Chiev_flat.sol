...
// File: https://github.com/Achievmintry/openzeppelin-contracts/blob/release-v2.5.0/contracts/GSN/Context.sol
...
// File: https://github.com/Achievmintry/openzeppelin-contracts/blob/release-v2.5.0/contracts/ownership/Ownable.sol
...
// File: https://github.com/Achievmintry/openzeppelin-contracts/blob/release-v2.5.0/contracts/introspection/IERC165.sol
...
// File: https://github.com/Achievmintry/openzeppelin-contracts/blob/release-v2.5.0/contracts/introspection/ERC165.sol
...
// File: https://github.com/Achievmintry/openzeppelin-contracts/blob/release-v2.5.0/contracts/token/ERC721/IERC721.sol
...
// File: https://github.com/Achievmintry/openzeppelin-contracts/blob/release-v2.5.0/contracts/token/ERC721/ERC721.sol
...
// File: https://github.com/Achievmintry/openzeppelin-contracts/blob/release-v2.5.0/contracts/token/ERC721/IERC721Metadata.sol
...
// File: https://github.com/Achievmintry/openzeppelin-contracts/blob/release-v2.5.0/contracts/token/ERC721/ERC721Metadata.sol
...
// File: https://github.com/Achievmintry/openzeppelin-contracts/blob/release-v2.5.0/contracts/token/ERC721/IERC721Enumerable.sol
...
// File: https://github.com/Achievmintry/openzeppelin-contracts/blob/release-v2.5.0/contracts/token/ERC721/ERC721Enumerable.sol
...
// File: https://github.com/Achievmintry/openzeppelin-contracts/blob/release-v2.5.0/contracts/drafts/Counters.sol
...
// File: https://github.com/Achievmintry/openzeppelin-contracts/blob/release-v2.5.0/contracts/utils/Address.sol
...
// File: https://github.com/Achievmintry/openzeppelin-contracts/blob/release-v2.5.0/contracts/math/SafeMath.sol
...
// File: https://github.com/Achievmintry/openzeppelin-contracts/blob/release-v2.5.0/contracts/token/ERC721/IERC721Receiver.sol
...
// File: https://github.com/Achievmintry/openzeppelin-contracts/blob/release-v2.5.0/contracts/token/ERC721/ERC721Full.sol
...
contract Chievs is ERC721Full("ChievToken", "CHIEV"), Ownable {
    ...
    event MintGen0(address indexed to, uint256 numClonesAllowed, uint256 indexed tokenId, address indexed cloner, uint256 priceFinney);
    ...
    // uint256 public clonerFeePercentage = 10;
    ...
    function mint(address _to, uint256 _priceFinney, uint256 _numClonesAllowed, string memory _tokenURI) public mintable onlyOwner returns (uint256 tokenId) {
        ...
        emit MintGen0(_to, _numClonesAllowed, tokenId, address(0), _priceFinney);
    ...
    function mintPermissioned(address _to, address _cloner, uint256 _priceFinney, uint256 _numClonesAllowed, string memory _tokenURI) public mintable onlyOwner returns (uint256 tokenId) {
        ...
        emit MintGen0(_to, _numClonesAllowed, tokenId, _cloner, _priceFinney);
    ...
    function clone(address _to, uint256 _tokenId, uint256 _numClonesRequested) public payable mintable {
        ...
        if(_chiev.cloner != address(0)){
            ...
            // uint256 contractClonerFee = (cloningCost.mul(clonerFeePercentage)).div(100);
            // address(_chiev.cloner).transfer(contractClonerFee);
        }
        ...
        for (uint i = 0; i < _numClonesRequested; i++) {
            ...
            emit Clone(msg.sender, _to, newTokenId, _tokenId, tokenOwnerFee, contractOwnerFee);
        }
